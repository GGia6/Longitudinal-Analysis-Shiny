...
## Tools & Technologies
- **R** 
- **Statistical methods:** Single variable & Batch Ordinal Logistic Regression with Brant Test Assumption check, Single variable & Batch Vector Generalized Linear Modeling, Exploratory Data Analysis, Non-response Analysis (Chi-Square Testing)
